...
class GlobalData {
  ...
  Future<void> _doFetch(String jwt) async {
    try {
      ...
      if (opsResp != null &&
          opsResp.statusCode >= 200 &&
          opsResp.statusCode < 300) {
        try {
          ...
          if (body.isEmpty) {
            ...
            final ops = list
                .map(
                  (e) =>
                      Operation.fromJson(Map<String, dynamic>.from(e as Map)),
                )
                .toList();
      ...
      if (subsResp != null &&
          subsResp.statusCode >= 200 &&
          subsResp.statusCode < 300) {
        try {
