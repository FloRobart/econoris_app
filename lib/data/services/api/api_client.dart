...
class ApiClient {
  static Future<http.Response> requestLoginCode(String email) {
    final url = Uri.parse('${AppConfig.floraccessServer}/users/login/request');
  ...
  static Future<http.Response> confirmLoginCode(
    ...
    final url = Uri.parse('${AppConfig.floraccessServer}/users/login/confirm');
    return http.post(
      url,
      headers: {'Content-Type': 'application/json'},
  ...
  static Future<http.Response> registerUser(String email, [String? pseudo]) {
    final url = Uri.parse('${AppConfig.floraccessServer}/users');
    final body = <String, dynamic>{'email': email};
  ...
  static Future<http.Response> logout(String jwt) {
    final url = Uri.parse('${AppConfig.floraccessServer}/users/logout');
  ...
  static Future<http.Response> getOperations(String jwt) {
    final url = Uri.parse('${AppConfig.econorisServer}/operations');
    return _wrap(http.get(url, headers: {'Authorization': 'Bearer $jwt'}));
  }

  static Future<http.Response> addOperation(
    String jwt,
  ...
  static Future<http.Response> updateOperation(
    ...
    final url = Uri.parse(
      '${AppConfig.econorisServer}/operations/$operationId',
    );
    return _wrap(
      http.put(
        url,
  ...
  static Future<http.Response> deleteOperation(String jwt, int id) {
    final url = Uri.parse('${AppConfig.econorisServer}/operations/$id');
    return _wrap(http.delete(url, headers: {'Authorization': 'Bearer $jwt'}));
  }

  // Subscriptions endpoints
  static Future<http.Response> getSubscriptions(String jwt) {
    final url = Uri.parse('${AppConfig.econorisServer}/subscriptions');
    return _wrap(http.get(url, headers: {'Authorization': 'Bearer $jwt'}));
  }

  static Future<http.Response> addSubscription(
    String jwt,
    Map<String, dynamic> body,
  ) {
    final url = Uri.parse('${AppConfig.econorisServer}/subscriptions');
  ...
  static Future<http.Response> updateSubscription(
    ...
    final url = Uri.parse(
      '${AppConfig.econorisServer}/subscriptions/$subscriptionId',
    );
    return _wrap(
      http.put(
        url,
  ...
  static Future<http.Response> deleteSubscription(
    String jwt,
    int subscriptionId,
  ) {
    final url = Uri.parse(
