...
final operationManagementIndexViewmodelProvider = Provider<AsyncValue<OperationManagementIndexViewmodel>>((ref) {
  final asyncMoneyManagementIndex = ref.watch(operationStatsProvider.select((asyncStats) => asyncStats.whenData((stats) => stats.monthlyMoneyManagementIndex)));
...
class OperationManagementIndexViewmodel {
  OperationManagementIndexViewmodel({
