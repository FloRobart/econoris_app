    ...
    void showManagementIndexHelper() {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'L\'indice de gestion d\'argent est une mesure qui évalue la performance de votre gestion financière.\n\nGlobalement, plus l\'indice est élevé, meilleure est votre gestion de l\'argent.\n\nSi votre indice est à 0 alors vous dépensez exactement ce que vous gagnez, si il est à -50 alors vous dépensez deux fois plus que ce que vous gagnez, et si il est à 100 alors vous gagnez deux fois plus que ce que vous dépensez.\n\nL\'indice est calculé en fonction de vos revenus et de vos dépenses sur le mois financier en cours, sans compter l\'épargne, ni les investissements.',
          ),
          actions: [
            TextButton(
