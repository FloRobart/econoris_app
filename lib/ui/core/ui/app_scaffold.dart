...
class AppScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color unselectedForeground = foreground.withAlpha(
      (0.7 * 255).toInt(),
    );
    ...
    final Color profileHighlightColor = isProfileSelected
        ? Colors.amber
        : foreground;
    ...
    return Scaffold(
          ...
          Padding(
            ...
            child: Builder(
              builder: (ctx) {
                ...
                final TextStyle? nameStyle = Theme.of(ctx).textTheme.titleMedium
                ...
                return FutureBuilder<String?>(
                  ...
                  builder: (c, snap) {
                    ...
                    children.add(
                      Icon(Icons.person, color: profileHighlightColor),
                    );
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: isProfileSelected
